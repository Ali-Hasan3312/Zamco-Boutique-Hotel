  ...
  <div className='flex flex-col gap-1'>
    ...
    <div className='mt-8 mx-4'>
        ...
        <ul className=''>
            ...
            <li className='my-2'>
                <Link to={"/"} className={`flex content-center mx-auto text-lg items-center gap-3 text-opacity-85 hover:bg-custom-blue hover:text-white transition-all duration-300 py-2 w-[200px] px-3 ${location.pathname==='/admin/logout'? 'bg-custom-blue text-white' : 'text-gray-800'}`}>
                <IoMdPower className=''/>
                Logout
                </Link>
            </li>
