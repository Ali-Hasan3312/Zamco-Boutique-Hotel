...
export const  InfoCard = ({ icon, title, description, to }:InfoCardProps) => {
  ...
  return (
    <motion.div 
      className="flex flex-col gap-3 items-center justify-center flex-wrap text-center px-8 h-[330px] w-[370px] sm:w-[490px] lg:w-[370px] mx-auto shadow-md bg-white border hover:shadow-xl"
