...
const Gallery = forwardRef<HTMLDivElement, GalleryProps>((props, ref) => {
  ...
  return (
    ...
    <div ref={ref} className=' mt-12' id='gallery'>
       ...
       <h1 className=' text-center lg:text-2xl text-5xl uppercase'>Our Gallery</h1>
        <div className='flex items-center justify-center gap-6 text-3xl lg:text-sm mt-8 lg:mt-2 max-sm:px-2 max-sm:gap-4 text-nowrap'>
       ...
       <div className='grid lg:grid-cols-4 gap-8 lg:gap-3 mt-10 max-sm:ml-0 grid-cols-1 max-sm:px-16'>
       {all && (
      <>
